...
public class ContractBuilder {
    ...
    public void start(Class cl, String version) {
        ...
        contractBuilder
                ...
                .append(LS)
                .append(INDENT).append("public static final Uri ADMIN_OBJECT_").append(upperUnqualifiedName).append("_URI = WebData.Object.objectUri(SCHEMA_ID, true);")
                .append(LS)
                .append(INDENT).append("public static final Uri CONFLICT_").append(upperUnqualifiedName).append("_URI = WebData.Object.conflictUri(SCHEMA_ID);")
                .append(LS)
                .append(INDENT).append("public static final Uri ADMIN_CONFLICT_").append(upperUnqualifiedName).append("_URI = WebData.Object.conflictUri(SCHEMA_ID, true);")
                .append(LS)
                .append(LS)
